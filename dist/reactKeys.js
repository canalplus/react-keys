  ...
  return (function(e) {
    ...
    function(e, t, r) {
      ...
      (t.addBinder = function(e, t) {
        ...
        (t.updatePressStatus = function(e, t = null) {
          (0, c.getPress)().press !== e &&
            (0, c.dispatch)({ type: E, press: e, keyCode: t });
        }),
        (t.execCb = s),
        (t.enterTo = d),
      ...
      const b = (t.ADD_BINDER = `${h.NAME}/ADD_BINDER`),
        ...
        E = (t.UPDATE_PRESS_STATUS = `${h.NAME}/UPDATE_PRESS_STATUS`);
    },
    function(e, t, r) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
    ...
    function(e, t, r) {
        ...
        a.default.isBlocked(r) ||
          ...
          !_ &&
            ...
            (t.pressTimeout = B = setTimeout(() => {
              E(r, 'long'), (0, c.updatePressStatus)(!0, r), (t.fired = _ = !0);
      ...
      (t.callListeners = i),
        ...
        (t._init = function(e) {
          e && e.store && (0, m.updateStore)(e.store),
            ...
            (t.eventCb = E = e && e.eventCb ? e.eventCb : () => ({})),
      ...
      let b = (t.keysListeners = []),
        ...
        E = (t.eventCb = null),
        S = (t.rkDebounce = g.DEBOUNCE_TIMEOUT),
    ...
    function(e, t, r) {
      ...
      (t.correctBoundsMargin = (e, t) => {
        ...
        (t.boundsMargin = (e, t, r) => {
          ...
          if (!(r && C !== e && R && x && a))
            return { marginLeft: O, marginTop: P, elements: M };
          ...
          return (
            ...
            { marginLeft: O, marginTop: P, elements: M }
          );
        });
    ...
    function(e, t, r) {
      ...
      (t._selector = e => () => {
        ...
        (t._isCurrentBinder = e => () => {
          return (
            (0, i.ensureState)(),
            ((0, n.getStore)().current &&
              (0, n.getStore)().current.binderId) === e
          );
        }),
    ...
    function(e, t, i) {
      ...
      class y extends d.Component {
          ...
          if (d === m.NAVIGATION_BOUND) {
            ...
            if (void 0 === b) {
              if (this.props.memory) {
                ...
                if (g && t !== g) return y.map(e => e + u * r(g - t));
              }
              return y;
            }
            const m = (0, a.calculateElSpace)(document.getElementById(l)),
              _ = r(i - h),
              v = u * _;
            return _ + (d - u) / u <= o(1, n(m.width / u) - 1)
        ...
        calcTargetIndexScrollPosition(e, t, r, i, o) {
    ...
    function(e, t, r) {
      ...
      t.next = (e, t, r, d) => {
        ...
        return 0 < e.length
          ? { selectedId: (u = e[0]).id, marginLeft: 0, marginTop: 0 }
    ...
    function(e, t, n) {
      ...
      function i(e, t, n, i) {
        const o = (0, d.getDomElement)(i.current.selectedId),
          s = o ? o.getBoundingClientRect()[n] : 0;
        return (0, d.getCurrentChildren)((0, d.getDomElement)(e), t)
          .map(e => ({ id: e.id, diff: r(e.getBoundingClientRect()[n] - s) }))
    ...
    function(e, t, r) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.keysHandler = function(e, t, r) {
          ...
          if (this.listenerId) {
            const S = (0, i.findBinder)((0, o.getBinders)(), n);
            if (S) {
              if (
                r &&
                E &&
              ...
              if (
                ...
                switch (e) {
                  ...
                  case c.default.enter:
                    B && ((0, d.block)(), (0, a.execCb)(B, S.nextEl, this));
                }
            }
          }
        });
    ...
    function(e, t, r) {
      ...
      class p extends i.Component {
        ...
        componentDidMount() {
          (this.mounted = !0),
            setTimeout(() => {
              this.mounted && f.mountState.apply(this);
            }, 0);
        }
        componentDidUpdate() {
